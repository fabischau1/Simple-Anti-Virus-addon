...
echo     "Quick Scan", "info", "Desktop Scan",
echo     "Scan For Damaged System", "Start Menu", "Info"
echo ^]
echo running = True
echo while running:
...
echo                         elif i == 4:
echo                             os.system^("start notepad C:\\FA_Antivira\\FApyHlp\\FAscaninfo.txt"^)
echo                         elif i == 5:
...
echo                             "3. Info", "FA_Antivira Start Menu"^)
echo     Select Case buttonClicked
echo         Case "1"
...
echo         Case "3"
echo             OpenFile "C:\FA_Antivira\FApyHlp\FAscaninfo.txt"
echo         Case Else
echo             MsgBox "Invalid input please type in a number from 1 to 3"
echo     End Select
echo End Sub
